...
yes.addEventListener("click", () => {
  ...
  yes.innerHTML = '<a href="https://www.instagram.com/rxhl.4?igsh=MTgwcmJobHlsM3JxdA%3D%3D&utm_source=qr">Message me</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
